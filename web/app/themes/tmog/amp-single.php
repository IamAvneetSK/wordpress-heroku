													...
													<div class="mvp-author-info-wrap left relative">
														...
														<div class="mvp-author-info-text left relative">
															...
															<div class="mvp-author-info-date left relative">
																<p><?php esc_html_e( 'Published on', 'click-mag' ); ?></p> <span class="mvp-post-date updated"><time class="post-date updated" itemprop="datePublished" datetime="<?php the_time('Y-m-d'); ?>"><?php the_time(get_option('date_format')); ?></time></span>
																	...
																	<div id="mvp-content-body-top" class="left relative">
																		...
																		<div class="mvp-org-wrap" itemprop="publisher" itemscope itemtype="https://schema.org/Organization">
																			<div class="mvp-org-logo" itemprop="logo" itemscope itemtype="https://schema.org/ImageObject">
																				<?php if(get_option('mvp_logo_nav')) { ?>
																					<amp-img src="<?php echo esc_url(get_option('mvp_logo_nav')); ?>" alt="<?php bloginfo( 'name' ); ?>" data-rjs="2" width="<?php echo esc_html(get_option('mvp_amp_logow')); ?>" height="<?php echo esc_html(get_option('mvp_amp_logoh')); ?>" layout="fixed"></amp-img>
																					<meta itemprop="url" content="<?php echo esc_url(get_option('mvp_logo_nav')); ?>">
																				<?php } else { ?>
																					<amp-img src="<?php echo get_template_directory_uri(); ?>/images/logos/logo-nav.png" alt="<?php bloginfo( 'name' ); ?>" data-rjs="2" width="<?php echo esc_html(get_option('mvp_amp_logow')); ?>" height="<?php echo esc_html(get_option('mvp_amp_logoh')); ?>" layout="fixed"></amp-img>
