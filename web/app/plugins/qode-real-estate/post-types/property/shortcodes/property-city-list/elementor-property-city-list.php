...
class QodeREPropertyCityList extends \Elementor\Widget_Base{
	public function get_name() {
		return 'bridge_property_city_list';
	}

	public function get_title() {
		return esc_html__( 'Property City List', 'qode-real-estate' );
	}

	public function get_icon() {
		return 'bridge-elementor-custom-icon bridge-elementor-property-city-list';
	}
...
\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new QodeREPropertyCityList() );
