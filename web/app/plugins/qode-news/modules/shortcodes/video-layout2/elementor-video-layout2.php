...
use qodeNews\CPT\Shortcodes\VideoLayout2 as LayoutFactory;

class QodeNewsVideoLayout2 extends \Elementor\Widget_Base{
    public function get_name() {
        return 'bridge_video_layout2';
    }

    public function get_title() {
        return esc_html__( 'Video Layout 2', 'qode-news' );
    }

    public function get_icon() {
        return 'bridge-elementor-custom-icon bridge-elementor-video-layout2';
    }
    ...
    protected function render(){
        ...
        $layout1Instance = new LayoutFactory\VideoLayout2();
        echo $layout1Instance->renderHolders( $params );
    }

}

\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new QodeNewsVideoLayout2() );