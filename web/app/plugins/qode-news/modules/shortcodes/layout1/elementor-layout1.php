...
use qodeNews\CPT\Shortcodes\Layout1 as LayoutFactory;

class QodeNewsLayout1 extends \Elementor\Widget_Base{
    public function get_name() {
        return 'bridge_layout1';
    }

    public function get_title() {
        return esc_html__( 'Layout 1', 'qode-news' );
    }

    public function get_icon() {
        return 'bridge-elementor-custom-icon bridge-elementor-layout1';
    }
    ...
    protected function render(){
        ...
        $layout1Instance = new LayoutFactory\Layout1();
        echo $layout1Instance->renderHolders( $params );
    }

}

\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new QodeNewsLayout1() );