...
use qodeNews\CPT\Shortcodes\VideoLayout1 as LayoutFactory;

class QodeNewsVideoLayout1 extends \Elementor\Widget_Base{
    public function get_name() {
        return 'bridge_video_layout1';
    }

    public function get_title() {
        return esc_html__( 'Video Layout 1', 'qode-news' );
    }
    ...
    protected function render(){
        ...
        $layout1Instance = new LayoutFactory\VideoLayout1();
