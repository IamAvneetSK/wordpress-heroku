...
use qodeNews\CPT\Shortcodes\Layout2 as LayoutFactory;

class QodeNewsLayout2 extends \Elementor\Widget_Base{
    public function get_name() {
        return 'bridge_layout2';
    }

    public function get_title() {
        return esc_html__( 'Layout 2', 'qode-news' );
    }

    public function get_icon() {
        return 'bridge-elementor-custom-icon bridge-elementor-layout2';
    }
    ...
    protected function render(){
        ...
        $layout1Instance = new LayoutFactory\Layout2();
        echo $layout1Instance->renderHolders( $params );
    }

}

\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new QodeNewsLayout2() );